  ...
  <div>
    <div class="container">
      <div class="handle-box">
        <el-button type="second" icon="el-icon-search" @click="handleSearchAll()"
          >搜索所有书籍</el-button
        >
        <el-select
          v-model="query.class"
      ...
      <el-button type="primary" icon="el-icon-plus" @click="addEdit" style="float:right"
          >增加</el-button
        >
        <!-- 添加弹出框 -->
    <el-dialog title="编辑" v-model="addVisible" width="30%">
      ...
      <el-form-item label="ID">
       <el-input v-model="aform.library_id"></el-input>
       </el-form-item>
       ...
       <el-input v-model="aform.language"></el-input>
        ...
        <el-form-item label="图书状态">
          <el-input v-model="aform.state	"></el-input>
        </el-form-item>
        <el-form-item label="图书损坏情况">
          <el-input v-model="aform.situation	"></el-input>
        </el-form-item>
...
export default {
 ...
 this.handlePageChange(this.query.pageindex);
    ...
    deleteBook()
    {
      ...
      axios
        .post(" http://localhost:5000" + "/admin/delete",this.borrow ,{
...
//              data:this.aform
//           })
axios.post("http://127.0.0.1:5000" + "admin/addbook",this.aform)
          .then(result=>{
          console.log(result);
          if(result.data)
          this.$message.success(`添加请求已发送成功！`);
          else{
